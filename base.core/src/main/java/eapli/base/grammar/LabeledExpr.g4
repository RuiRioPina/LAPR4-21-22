...
OBLIGATORINESS_ENUM: 'MANDATORY' | 'OPTIONAL' | 'CONDITION DEPENDENT'SENTENCE*;
CHOOSE: [0-9]+('- ')SENTENCE*  RANGE_OPTIONS*('|')*;

FREE_TEXT: 'TYPE: FREE-TEXT';
MULTIPLE_CHOICE: 'TYPE: MULTIPLE-CHOICE';
MULTIPLE_CHOICE_INPUT_VALUE: 'TYPE: MULTIPLE-CHOICE-INPUT-VALUE';
SINGLE_CHOICE: 'TYPE: SINGLE-CHOICE';
SINGLE_CHOICE_INPUT_VALUE: 'TYPE: SINGLE-CHOICE-INPUT-VALUE';
NUMERIC: 'TYPE: NUMERIC';
SORTING_OPTIONS: 'TYPE: SORTING-OPTIONS';
SCALING_OPTIONS: 'TYPE: SCALING-OPTIONS';
