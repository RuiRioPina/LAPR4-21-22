...
public class ProductOrdersBoostrapper implements Action {
    ...
    public boolean execute() {
        ...
        Optional<Customer> customer2 = PersistenceContext.repositories().customers().findById(13L);
        Optional<Customer> customer3 = PersistenceContext.repositories().customers().findById(15L);
