...
public class ProductBootstrapper implements Action {
    ...
    public boolean execute() {
        ...
        registerProduct(cats.get(0), Designation.valueOf("Radmi II"), "smarthphone_radmi_II.jpg",new ProductDescription("Smartphone Radmi II",
        ...
        registerProduct(cats.get(0),Designation.valueOf("6W Plus"),"smartphone_6w_plus.png",new ProductDescription("Smarthphone 6W Plus",
        ...
        registerProduct(cats.get(0),Designation.valueOf("Galatic"),"smartphone_galatic.jpg",new ProductDescription("Smarthphone Galatic",
        ...
        registerProduct(cats.get(1),Designation.valueOf("Avillon"),"laptop_avillon.jpg",new ProductDescription("Laptop Avillon",
        ...
        registerProduct(cats.get(1),Designation.valueOf("LiveBook"),"laptop_livebook.jpg",new ProductDescription("Laptop LiveBook",
        ...
        registerProduct(cats.get(1),Designation.valueOf("TapperBook"),"laptop_tapperbook.jpg",new ProductDescription("Laptop TapperBook",
        ...
        registerProduct(cats.get(2),Designation.valueOf("QE55Q75AA"),"tv_QE55Q75AA.png",new ProductDescription("TV QE55Q75A",
        ...
        registerProduct(cats.get(2),Designation.valueOf("UE43TU7025"),"tv_UE43TU7025.jpg",new ProductDescription("TV UE43TU7025",
        ...
        registerProduct(cats.get(2),Designation.valueOf("55UP78006AZDER"),"tv_55UP78006AZDER.jpg",new ProductDescription("TV 55UP78006AZDER",
    ...
    private void registerProduct(Category category, Designation name, String photoPath,ProductDescription description, Brand brand,
        ...
        controller.specifyNewProduct(category,name,photoPath,description,brand,price,reference,internalCode,productionCode,barcode, location);
    }
